...
public interface OwlDslVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link OwlDslParser#allDisjointClassesPhrase}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAllDisjointClassesPhrase(OwlDslParser.AllDisjointClassesPhraseContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link OwlDslParser#isA}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIsA(OwlDslParser.IsAContext ctx);
	/**
	 * Visit a parse tree produced by {@link OwlDslParser#isEquivalent}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIsEquivalent(OwlDslParser.IsEquivalentContext ctx);
	/**
	 * Visit a parse tree produced by {@link OwlDslParser#isDisjoint}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIsDisjoint(OwlDslParser.IsDisjointContext ctx);
	/**
	 * Visit a parse tree produced by {@link OwlDslParser#has}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHas(OwlDslParser.HasContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code ObjectPropEquivalentClause}
	 * labeled alternative in {@link OwlDslParser#objectPropertyClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjectPropEquivalentClause(OwlDslParser.ObjectPropEquivalentClauseContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ObjectPropDisjointClause}
	 * labeled alternative in {@link OwlDslParser#objectPropertyClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjectPropDisjointClause(OwlDslParser.ObjectPropDisjointClauseContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code DataPropEquivalentClause}
	 * labeled alternative in {@link OwlDslParser#dataPropertyClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDataPropEquivalentClause(OwlDslParser.DataPropEquivalentClauseContext ctx);
	/**
	 * Visit a parse tree produced by the {@code DataPropDisjointClause}
	 * labeled alternative in {@link OwlDslParser#dataPropertyClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDataPropDisjointClause(OwlDslParser.DataPropDisjointClauseContext ctx);
	/**
