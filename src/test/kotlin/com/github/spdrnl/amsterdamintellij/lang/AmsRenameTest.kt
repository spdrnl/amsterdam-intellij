...
class AmsRenameTest : BasePlatformTestCase() {
    ...
    fun testRenameIriToFullIriWithoutBrackets() {
        ...
        myFixture.renameElementAtCaret("http://example.org/NewIri")
        assertTrue("IRI should be updated and wrapped in brackets", myFixture.file.text.contains("<http://example.org/NewIri>"))
    }
    ...
    fun testElementDescription() {
        ...
        val curieDesc = provider.getElementDescription(curieElement!!, object : RefactoringDescriptionLocation(false) {})
